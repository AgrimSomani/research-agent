...
from utils import scrape_website,search
...
class ScrapeWebsiteTool(BaseTool):
    name = "scrape-website"
    description = "useful when you need to get the data from a website url, passing both the website url and the objective to the function; DO NOT make any urls up."
